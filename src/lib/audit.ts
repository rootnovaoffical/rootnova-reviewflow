...
export async function logAudit(action: string, targetType: string, targetId: string | null = null, organizationId: string | null = null, metadata?: Record<string, unknown>): Promise<void> {
  try {
