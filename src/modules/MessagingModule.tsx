...
export function MessagesModule({ businessId }: Props) { return <DataManager table="messages" businessId={businessId} columns={messageColumns} defaultValues={{ channel: 'sms', direction: 'outbound', status: 'pending' }} />; }
export function MessageTemplatesModule({ businessId }: Props) { return <DataManager table="message_templates" businessId={businessId} columns={templateColumns} defaultValues={{ is_active: true, variables: [] }} />; }
export function ScheduledMessagesModule({ businessId }: Props) { return <DataManager table="scheduled_messages" businessId={businessId} columns={scheduledColumns} defaultValues={{ channel: 'sms', status: 'pending' }} />; }
