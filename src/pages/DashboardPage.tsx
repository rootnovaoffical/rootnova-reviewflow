...
interface NavGroup { id: string; label: string; icon: IconType; items: NavItem[]; roles?: string[]; }
...
const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'developer', label: 'Developer', icon: Code2, roles: ['ROOTNOVA_SUPER_ADMIN','ROOTNOVA_ADMIN','PARTNER_OWNER','PARTNER_ADMIN'], items: [
    { id: 'api_keys', label: 'API Keys', icon: Key },
    { id: 'developer_apps', label: 'Apps', icon: Code2 },
    { id: 'webhooks', label: 'Webhooks', icon: Webhook },
  ]},
  { id: 'billing', label: 'Billing', icon: CreditCard, roles: ['ROOTNOVA_SUPER_ADMIN','ROOTNOVA_ADMIN','PARTNER_OWNER','PARTNER_ADMIN'], items: [
    { id: 'plans', label: 'Plans', icon: CreditCard },
    { id: 'subscriptions', label: 'Subscriptions', icon: CreditCard },
    { id: 'payments', label: 'Payments', icon: CreditCard },
    { id: 'invoices', label: 'Invoices', icon: FileText },
  ]},
  { id: 'enterprise', label: 'Enterprise', icon: Building2, roles: ['ROOTNOVA_SUPER_ADMIN','ROOTNOVA_ADMIN','PARTNER_OWNER','PARTNER_ADMIN'], items: [
  ...
  { id: 'platform', label: 'Platform', icon: Shield, roles: ['ROOTNOVA_SUPER_ADMIN'], items: [
...
function NoOrg() { return <div className="text-center py-16 text-zinc-500">This module requires an organization. Select a business that belongs to an organization.</div>; }
