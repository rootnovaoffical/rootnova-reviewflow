...
export default {
  ...
  theme: { extend: {
    ...
    animation: {
      "fade-in":"fadeIn 0.5s ease-out","slide-up":"slideUp 0.4s ease-out","scale-in":"scaleIn 0.3s ease-out",
      "shimmer":"shimmer 2s linear infinite","float":"float 6s ease-in-out infinite","aurora":"aurora 8s ease-in-out infinite alternate",
      "spring-in":"springIn 0.5s cubic-bezier(0.34,1.56,0.64,1)","pulse-glow":"pulseGlow 2s ease-in-out infinite",
    },
    keyframes: {
